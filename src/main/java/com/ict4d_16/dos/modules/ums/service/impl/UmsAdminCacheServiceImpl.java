...
import com.ict4d_16.dos.common.service.RedisService;
import com.ict4d_16.dos.modules.ums.mapper.UmsAdminMapper;
import com.ict4d_16.dos.modules.ums.model.UmsAdmin;
import com.ict4d_16.dos.modules.ums.model.UmsAdminRoleRelation;
...
public class UmsAdminCacheServiceImpl implements UmsAdminCacheService {
    ...
    @Override
    public void setAdminByUsername(UmsAdmin admin) {
        String key = REDIS_DATABASE + ":" + REDIS_KEY_ADMIN + ":" + admin.getUsername();
        redisService.set(key, admin, REDIS_EXPIRE);
    }

    @Override
    public void setAdminByPhone(UmsAdmin admin) {
